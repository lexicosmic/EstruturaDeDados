...
int main()
{
    ...
    if (vet)
        for (int i = 0; i < n; i++)
            cout << vet[i] << " ";
    cout << endl;
    cout << "Esperado: 6 8 10 12 17 19 24 (alem dos possiveis valores -1)" << endl
         << endl;
    delete[] vet;
    cout << endl;
    // -----------------------------------------------------------------------------
    ...
    arv.removeMenor(6);
    arv.imprime();
    cout << "    Esperado: 6 7 8 9 10 11 12 15 17 18 19 20 24" << endl
         << endl;

    cout << "Removendo nos menores do que 7" << endl;
    arv.removeMenor(7);
    arv.imprime();
    cout << "    Esperado: 7 8 9 10 11 12 15 17 18 19 20 24" << endl
         << endl;

    cout << "Removendo nos menores do que 11" << endl;
    arv.removeMenor(11);
    arv.imprime();
    cout << "    Esperado: 11 12 15 17 18 19 20 24" << endl
         << endl;

    cout << "Removendo nos menores do que 15" << endl;
    arv.removeMenor(15);
    arv.imprime();
    cout << "    Esperado: 15 17 18 19 20 24" << endl
         << endl;

    cout << "Removendo nos menores do que 18" << endl;
    arv.removeMenor(18);
    arv.imprime();
    cout << "    Esperado: 18 19 20 24" << endl
         << endl;

    cout << "Removendo nos menores do que 23" << endl;
    arv.removeMenor(23);
    arv.imprime();
    cout << "    Esperado: 24" << endl
         << endl;
