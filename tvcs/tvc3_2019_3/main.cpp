...
int main()
{
    ...
    // ARVORES DE TESTE
    ArvBinBusca abb1, abb2, abb3, abb4;
    ...
    // TESTE DA QUESTAO 3 -----------------------------------------------------
    cout << endl
         << "-------TESTES DA QUESTAO 3----------" << endl;
    abb1.imprimePorNivel();
    ...
    testeQ3(abb4, -35, 60, 0);   /// intervalo [-35, 60], nivelk = 3
...
void testeQ3(ArvBinBusca arv, int a, int b, int nivel)
{
    ...
    cout << endl
         << "Vetor ordenado do nivel: " << nivel << endl;
    if (vOrd != NULL)
    {
