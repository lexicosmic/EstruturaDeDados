...
int main()
{
     ...
     // cout << endl;
     // cout << "1 no: " << endl;
     // arv1No.imprimeAluno(7.1);
     // cout << endl;
     // cout << "1 folha: " << endl;
     // arv1Folha.imprimeAluno(14);
     // arv1Folha.imprimeAluno(7.1);
     // cout << endl;
     // cout << "Completa: " << endl;
     // arvCompleta.imprimeAluno(7.9);
     // arvCompleta.imprimeAluno(7.8);
     // arvCompleta.imprimeAluno(0);
     // arvCompleta.imprimeAluno(9.1);
     // arvCompleta.imprimeAluno(7.1);
     // arvCompleta.imprimeAluno(6.5);
     // cout << endl;
     ...
     // arvVazia.remove(3);
     // arv1No.remove(7.1);
     // arv1Folha.remove(7.1);
     // arvCompleta.remove(0);
     // arvCompleta.remove(9.1);
     // arvCompleta.remove(7.1);
     // arvCompleta.remove(6.4);
     // arvCompleta.remove(6.6);
